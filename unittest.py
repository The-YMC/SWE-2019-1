...
class TestLogic(unittest.Testcase):
    ...
    def back_do1(self, user_info, n_piece):
        ...
        self.assertEqaul(map_result[25][2], user_info)
        self.assertEqaul(map_result[25][3], n_piece)
    ...
    def back_do2(self, user_info, n_piece):
        ...
        map_result, _ , _ , _ = tmap.select(-1, 28, user_info)
        self.assertEqaul(map_result[21][2], user_info)
        self.assertEqaul(map_result[21][3], n_piece)
    ...
    def back_do3(self, user_info, n_piece):
        ...
        self.assertEqaul(map_result[14][2], user_info)
        self.assertEqaul(map_result[14][3], n_piece)
    ...
    def back_do4(self, user_info, n_piece):
        ...
        map_result, _ , _ , _ = tmap.select(-1, 15, user_info)
        self.assertEqaul(map_result[23][2], user_info)
        self.assertEqaul(map_result[23][3], n_piece)
    ...
    def back_do5(self, user_info, n_piece):
        ...
        self.assertEqaul(map_result[10][2], user_info)
        self.assertEqaul(map_result[10][3], n_piece)
    ...
    def back_do6(self, user_info, n_piece):
        ...
        self.assertEqaul(map_result[5][2], user_info)
        self.assertEqaul(map_result[5][3], n_piece)
