...
class Map():
    ...
    def __init__(self, n_player, n_piece):
        ...
        """
        self.map_list = [[False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0],
                         [False, None, -1, 0],
                         [True, 'up', -1, 0], [False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0],
                         [False, None, -1, 0],
                         [True, 'down', -1, 0], [False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0],
                         [None, None, -1, 0],
                         [False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0], [False, None, -1, 0],
                         [None, None, -1, 0],
    ...
    def change_info(self, departure, destination, generate=False):
        ...
        if generate:
            if self.map_list[destination][2] == self.user_info or self.map_list[destination][2] == -1:
                ...
                turn_change = False
                self.user_remained[self.map_list[destination][2]] = self.user_remained[self.map_list[destination][2]] + \
                                                                    self.map_list[destination][3]
                self.map_list[destination][2] = self.user_info
